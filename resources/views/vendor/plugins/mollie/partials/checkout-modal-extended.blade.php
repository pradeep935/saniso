    ...
    <x-slot:footer>
        <div class="d-flex flex-column flex-sm-row justify-content-between w-100 gap-2">
            ...
            <div id="checkout-action-buttons" class="order-1 order-sm-2">
                <!-- Default Complete Order button -->
                <x-core::button color="primary" id="complete-order-btn" class="complete-order-btn">
                    <x-core::icon name="ti ti-check" class="me-1" />
                    {{ trans('plugins/pos-pro::pos.complete_order') }}
                </x-core::button>
                
                <!-- Pay Now button for Mollie Terminal (hidden by default) -->
                <x-core::button color="success" id="pay-now-btn" class="pay-now-btn" style="display: none;">
