...
return [
    ...
    // Performance optimization: limit initial media load
    'pagination' => [
        'per_page' => env('RV_MEDIA_PER_PAGE', 50), // Reduced from 30 to 50 for better UX
        'max_per_page' => env('RV_MEDIA_MAX_PER_PAGE', 100), // Maximum items per page
    ],
