...
Route::group([
    ...
    Route::group(['prefix' => 'quote-requests', 'as' => 'quote-requests.'], function (): void {
        Route::get('/', [
            'as' => 'index',
            'uses' => 'VendorQuoteRequestController@index',
        ]);
        
        Route::get('{id}', [
            'as' => 'show', 
            'uses' => 'VendorQuoteRequestController@show',
        ])->wherePrimaryKey();
        
        Route::patch('{id}/respond', [
            'as' => 'respond',
            'uses' => 'VendorQuoteRequestController@respond',
        ])->wherePrimaryKey();
        
        Route::patch('{id}/status', [
            'as' => 'update-status',
            'uses' => 'VendorQuoteRequestController@updateStatus', 
        ])->wherePrimaryKey();
    });
