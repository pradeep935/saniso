...
return [
    ...
    [
        ...
        'flag' => 'project-requests.index',
        'parent_flag' => 'plugins.ecommerce',
    ],
    [
        'name' => 'View',
        'flag' => 'project-requests.show',
        'parent_flag' => 'project-requests.index',
    ],
    [
        'name' => 'Update',
        'flag' => 'project-requests.edit',
        'parent_flag' => 'project-requests.index',
    ],
    [
        'name' => 'Delete',
        'flag' => 'project-requests.destroy',
        'parent_flag' => 'project-requests.index',
    ],
    ...
    [
        ...
        'flag' => 'ecommerce.picking-list-template.index',
        'parent_flag' => 'ecommerce.settings',
    ],
    [
        'name' => 'Currencies',
