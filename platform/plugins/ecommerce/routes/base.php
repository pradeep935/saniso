...
AdminHelper::registerRoutes(function (): void {
    Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'prefix' => 'ecommerce'], function (): void {
        ...
        Route::get('store-locators/search', [
            'as' => 'store-locators.search',
            'uses' => 'StoreLocatorController@search',
        ...
        // Project Form Builder routes
        Route::group(['prefix' => 'project-form-builder', 'as' => 'project-form-builder.'], function (): void {
            Route::get('/', [
                'as' => 'index',
