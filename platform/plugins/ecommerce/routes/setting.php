    ...
    Route::group([
        ...
        Route::group(['prefix' => 'ecommerce'], function (): void {
            Route::prefix('settings')->group(function (): void {
                ...
                Route::get('picking-list-template', [
                    'as' => 'ecommerce.settings.picking-list-template',
                    'uses' => 'PickingListTemplateSettingController@edit',
                    'permission' => 'ecommerce.picking-list-template.index',
                ]);

                Route::put('picking-list-template', [
                    'as' => 'ecommerce.settings.picking-list-template.update',
                    'uses' => 'PickingListTemplateSettingController@update',
                    'permission' => 'ecommerce.picking-list-template.index',
                    'middleware' => 'preventDemo',
                ]);

                Route::post('picking-list-template/reset/{template}', [
                    'as' => 'ecommerce.settings.picking-list-template.reset',
                    'uses' => 'PickingListTemplateSettingController@reset',
                    'permission' => 'ecommerce.picking-list-template.index',
                    'middleware' => 'preventDemo',
                ]);

                Route::get('picking-list-template/preview/{template}', [
                    'as' => 'ecommerce.settings.picking-list-template.preview',
                    'uses' => 'PickingListTemplateSettingController@preview',
                    'permission' => 'ecommerce.picking-list-template.index',
                ]);
