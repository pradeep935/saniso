...
return [
    ...
    'export' => [
        'filter_products' => 'Filter Products to Export',
        'filter_products_description' => 'Apply filters to export only specific products based on categories, brands, status, etc.',
        'categories_helper' => 'Select specific categories to export products from. Leave empty to export from all categories.',
        'brands_helper' => 'Select specific brands to export products from. Leave empty to export from all brands.',
        'status_helper' => 'Select specific statuses to export. Leave empty to export all products regardless of status.',
        'product_type_helper' => 'Choose between physical and digital products. Leave empty to export all product types.',
        'stock_status_helper' => 'Select specific stock statuses to export. Leave empty to export all products regardless of stock status.',
        'featured_helper' => 'Choose to export only featured products, non-featured products, or all products.',
        'filter_info' => 'If no filters are selected, all products will be exported. Use these filters to create targeted exports.',
        'select_categories' => 'Select categories...',
        'select_brands' => 'Select brands...',
        'select_status' => 'Select status...',
        'select_product_types' => 'Select product types...',
        'select_stock_status' => 'Select stock status...',
        'all_products' => 'All Products',
        'featured_only' => 'Featured Products Only',
        'non_featured_only' => 'Non-Featured Products Only',
        'total_items' => 'Total Items',
        'total_products' => 'Total Products',
        'total_variations' => 'Total Variations',
        'use_chunked_export' => 'Use chunked export for better performance',
        'use_chunked_export_helper' => 'Process data in smaller chunks to prevent memory issues and timeouts.',
        'optimize_memory' => 'Optimize memory usage',
        'optimize_memory_helper' => 'Use memory-efficient queries to reduce server load during export.',
        'use_streaming' => 'Use streaming export',
        'use_streaming_helper' => 'Stream data directly to download for large datasets.',
        'include_variations' => 'Include product variations',
        'include_variations_helper' => 'Export all product variations along with main products.',
        'chunk_size' => 'Chunk Size',
        'chunk_size_helper' => 'Number of products to process at once. Lower values are safer for large exports.',
        'recommended_range' => 'Recommended',
        'range_large_export' => '200-500',
        'range_medium_export' => '300-800',
        'range_small_export' => '500-1000',
        'optimal_range' => 'Optimal range',
        ...
        'estimated_time_prefix' => 'Est.',
        'seconds_remaining' => 's remaining',
        'export_completed' => 'Export completed!',
        'download_starting' => 'Download starting...',
        'starting_export' => 'Starting export...',
        'streaming_enabled_title' => 'Streaming Enabled',
        'streaming_enabled_message' => 'Streaming mode is automatically enabled for large exports to ensure optimal performance.',
        'large_dataset_warning_title' => 'Large Dataset Detected',
        'large_dataset_specific_message' => 'You\'re about to export :count items. This is a large dataset that requires special handling.',
        'format_label' => 'Format',
        'csv_recommended' => 'CSV recommended for large exports',
        'chunk_label' => 'Processing',
        'chunk_recommended' => 'Smaller chunks prevent timeouts',
        'time_label' => 'Time Estimate',
        'time_estimate' => '5-15 minutes for this size',
        'pro_tip' => 'Pro Tip:',
        'pro_tip_message' => 'Use filters to export only the products you need and reduce processing time.',
        'medium_dataset_detected' => 'Medium Dataset Detected',
        'medium_dataset_message' => 'You\'re about to export :count items. The export should complete within a few minutes.',
        'excel_disabled_warning' => 'Excel format disabled for exports over :count items for performance reasons.',
        'products_to_export' => 'Products to export: :count',
        'products_to_export_prefix' => 'Will export',
        'products_to_export_suffix' => 'items',
        'refresh_count' => 'Refresh',
        'updating' => 'Updating...',
        'count_error' => 'Error calculating count',
        'products' => 'products',
