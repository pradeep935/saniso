        ...
        <div class="col-md-12">
            <div class="widget meta-boxes">
                <div class="widget-title">
                    <h4>{{ trans('core/base::forms.edit_item', ['name' => $field->label]) }}</h4>
                </div>
                <div class="widget-body">
                    <form method="POST" action="{{ route('project-form-builder.update', $field->id) }}" class="row">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="type" name="type" required>
                                    @foreach($fieldTypes as $key => $type)
                                        <option value="{{ $key }}" {{ old('type', $field->type) == $key ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                                @error('type')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="field_width" name="field_width">
                                    <option value="col-12" {{ old('field_width', $field->field_width) == 'col-12' ? 'selected' : '' }}>Full Width (12/12)</option>
                                    <option value="col-6" {{ old('field_width', $field->field_width) == 'col-6' ? 'selected' : '' }}>Half Width (6/12)</option>
                                    <option value="col-4" {{ old('field_width', $field->field_width) == 'col-4' ? 'selected' : '' }}>One Third (4/12)</option>
                                    <option value="col-3" {{ old('field_width', $field->field_width) == 'col-3' ? 'selected' : '' }}>Quarter Width (3/12)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="placeholder" name="placeholder" value="{{ old('placeholder', $field->placeholder) }}">
                                @error('placeholder')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12" id="options-group" style="display: none;">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="options" name="options" rows="3" placeholder="Enter options separated by new lines">{{ old('options', $field->options) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="validation_rules" name="validation_rules" value="{{ old('validation_rules', $field->validation_rules) }}" placeholder="max:255,email,numeric">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="help_text" name="help_text" value="{{ old('help_text', $field->help_text) }}">
                                @error('help_text')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">
                                    <input type="checkbox" name="required" value="1" {{ old('required', $field->required) ? 'checked' : '' }}>
