    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
            <div class="bb-product-page-content">
                ...
                <style>
                    .bb-product-page-content .product-description { white-space: pre-line; line-height:1.45; }
                </style>
                <p
                    class="product-description"
                    id="detail-description"
                >
                    <span class="short-description">{!! BaseHelper::clean($product->description) !!}</span>
                </p>
