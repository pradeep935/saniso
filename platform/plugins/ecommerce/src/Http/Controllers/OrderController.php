...
class OrderController extends BaseController
{
    ...
    public function getGeneratePickingList(Order $order, Request $request)
    {
        if ($request->input('type') == 'print') {
            return app(\Botble\Ecommerce\Supports\PickingListHelper::class)->streamPickingList($order);
        }

        return app(\Botble\Ecommerce\Supports\PickingListHelper::class)->downloadPickingList($order);
    }
