    ...
    public function setup(): void
    {
        $this
            ...
            ->addItems([
                ...
                PanelSectionItem::make('settings.ecommerce.picking_list_template_settings')
                    ->setTitle(trans('plugins/ecommerce::picking-list-template.name'))
                    ->withIcon('ti ti-list-check')
                    ->withDescription(trans('plugins/ecommerce::picking-list-template.setting_description'))
                    ->withPriority(121)
                    ->withRoute('ecommerce.settings.picking-list-template'),
