...
use Botble\Ecommerce\Facades\PickingListHelper;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $loader->alias('PickingListHelper', PickingListHelper::class);
    ...
    public function boot(): void
    {
        ...
        DashboardMenu::beforeRetrieving(function (): void {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce-project-requests',
                    'priority' => 36,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'Project Requests',
                    'icon' => 'ti ti-building',
                    'url' => fn () => route('project-requests.index'),
                    'permissions' => ['project-requests.index'],
                ])
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce-project-form-builder',
                    'priority' => 37,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'Project Form Builder',
                    'icon' => 'ti ti-file-text',
                    'url' => fn () => route('project-form-builder.index'),
                    'permissions' => ['project-requests.index'],
                ])
                ->registerItem([
                    'id' => 'cms-plugins-ecommerce-project-quote-form-builder',
                    'priority' => 38,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'Project Quote Form Builder',
                    'icon' => 'ti ti-calculator-filled',
                    'url' => fn () => route('project-quote-form-builder.index'),
                    'permissions' => ['project-requests.index'],
                ])
        ...
        DashboardMenu::for('customer')->beforeRetrieving(function (): void {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-customer-quote-requests',
                    'priority' => 45,
                    'name' => __('Quote Requests'),
                    'url' => fn () => route('customer.quote-requests.index'),
                    'icon' => 'ti ti-quote',
                ])
                ->registerItem([
