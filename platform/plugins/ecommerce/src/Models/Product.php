...
class Product extends BaseModel
{
    ...
    /**
     * Default attribute values for new Product instances.
     */
    ...
    public function storeLocator(): BelongsTo
    {
        return $this->belongsTo(StoreLocator::class, 'store_id')->withDefault();
    }
    ...
    /**
     * Check if product is quote-only (price is 0 or null)
     */
    ...
    /**
     * Check if product can be added to cart normally (has a price)
     */
    public function canAddToCartDirectly(): bool
    {
