...
if (request() && request()->is('admin/*')) {
    require_once __DIR__ . '/admin-mobile-menu-helpers.php';
} 
...
Menu::addMenuLocation('mobile-menu', __('Mobile Menu'));
...
app()->booted(function (): void {
    ...
    register_sidebar([
        ...
        'name' => __('Footer Categories'),
        'description' => __('Product categories widget area in footer'),
    ]);
