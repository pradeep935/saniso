    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="product-modal-entry product-details js-product-content">
                ...
                <style>
                    .product-modal-entry .product-price-with-tax { margin-bottom: .6rem; }
                    .product-modal-entry .product-details__short-description .short-description { white-space: pre-line; line-height:1.45; }
                </style>

                <div class="product-details__short-description">
                    {!! apply_filters('ecommerce_before_product_description', null, $product) !!}
                    <div class="short-description">{!! BaseHelper::clean($product->description) !!}</div>
