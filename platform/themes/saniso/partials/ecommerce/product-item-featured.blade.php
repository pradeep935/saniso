...
@php
    ...
    // Check if this product is in quote mode
    ...
    $showPrice = $isQuoteMode ? false : ($showPrice ?? true); // Hide price in quote mode
    $showDescription = $showDescription ?? false;
    $showStoreInfo = $showStoreInfo ?? false;
    $showLabels = $showLabels ?? true;
    $showAddToCart = $isQuoteMode ? false : ($showAddToCart ?? true); // Hide add to cart in quote mode
...
<div class="product-thumbnail">
            ...
            <span class="ribbons">
                ...
                @else
                    @if ($product->productLabels->isNotEmpty())
                        ...
                        @endforeach
                    @else
                        @if ($product->front_sale_price !== $product->price && !$isQuoteMode)
                            <div
    ...
    @if ($showWishlist || $showAddToCart)
        {!! Theme::partial(
            'ecommerce.product-loop-buttons-featured',
...
<div class="product-details position-relative">
    <div class="product-content-box">
        ...
        @if ($showPrice)
            {!! Theme::partial('ecommerce.product-price-with-tax', compact('product')) !!}
        @endif
