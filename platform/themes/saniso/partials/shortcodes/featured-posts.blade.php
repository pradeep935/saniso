        ...
        <div class="row">
                            ...
                            <div class="card post-item__inner">
                                <div class="row g-0">
                                    <div class="col-md-4 post-item__image">
                                        <a
                                            class="img-fluid-eq blog-image-link"
                                            href="{{ $post->url }}"
                                        >
            ...
            @if ($shortcode->app_enabled)
                <div class="col-lg-4 py-4 py-lg-0">
                    ...
                    >
                        @if ($shortcode->app_title)
                            <div class="widget-header text-center me-0">
                                <h2>{!! BaseHelper::clean($shortcode->app_title) !!}</h2>
                            </div>
                        @endif

                        @if ($shortcode->app_description || ($shortcode->app_ios_img && $shortcode->app_ios_link) || ($shortcode->app_android_img && $shortcode->app_android_link))
                            <div class="widget-subtitle text-center">
                                @if($shortcode->app_description)
                                ...
                                <div>
                                    @if ($shortcode->app_ios_img && $shortcode->app_ios_link)
                                        <a
                                            href="{{ url($shortcode->app_ios_link) }}"
                                            title="iOS"
                                        >
                                            <img
                                    ...
                                    @if ($shortcode->app_android_img && $shortcode->app_android_link)
                                        <a
                                            href="{{ url($shortcode->app_android_link) }}"
                                            title="Android"
                                        >
                                            <img
                                                class="my-4 mx-2 lazyload"
